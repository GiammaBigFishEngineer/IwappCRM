...
export const MotivationUpdate = ({item}) => {
    ...
    const handleInputChange = (e) => {
        ...
        myObjectCopy.nome_motivazione = e.target.nome_motivazione;       
        // aggiorna lo stato con il nuovo oggetto JSON
        setObj(myObjectCopy);
        console.log(e.target.nome_motivazione);
      }
  return (
    <div>
        ...
        <input type="text" onChange={handleInputChange} value={obj.nome_motivazione} name="nome_motivazione" className="form-control" placeholder="Nome" aria-label="Username" aria-describedby="basic-addon1"/>
        </div>
