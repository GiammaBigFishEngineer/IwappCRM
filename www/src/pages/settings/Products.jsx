...
export const Products = () => {
  ...
  const list = RenderList(URL+'prodotti');
  ...
  function Delete(id) {
    ...
    if (answer) {
        ...
        window.location.href = URL+'elimina_prodotto?id='+id;
    }   
  }
  ...
  <tbody>
    {list.map(item=>(
      ...
      <td>{item.stock}</td>
      <td>
        {organizer ? <a className="text-primary" data-bs-toggle="modal" data-bs-target={'#'+item.id}>
